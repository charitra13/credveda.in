      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="xl:col-span-2 flex flex-col gap-6 sm:gap-8">
            ...
            {/* Bottom Cards Grid Wrapper with flex-grow */}
            <div className="flex-grow">
              <motion.div 
                className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 sm:gap-8"
                variants={itemVariants}
              >
                {/* Financial Advisors Card */}
                <motion.div 
                  className="bg-white p-4 sm:p-6 rounded-lg shadow-md flex flex-col h-full"
                  variants={itemVariants}
                >
          ...
          <div className="xl:col-span-3 flex flex-col gap-6 sm:gap-8">
            ...
            {/* Loan Comparison Card Wrapper with flex-grow */}
            <div className="flex-grow">
              <motion.div 
                className="bg-white p-4 sm:p-6 rounded-lg shadow-md flex flex-col h-full"
                variants={itemVariants}
